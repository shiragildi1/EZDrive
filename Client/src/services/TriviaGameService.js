...
export function submitAnswer({ sessionId, questionId, selectedAnswer }) {
  ...
  return fetch(`${API_BASE}/game-sessions/submit-answer`, {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    credentials: "include",
    body: JSON.stringify({ sessionId, questionId, selectedAnswer }),
...
export function getGameResult(sessionId) {
  return fetch(
    `${API_BASE}/game-sessions/result-trivia?sessionId=${sessionId}`,
    {
      method: "GET",
      credentials: "include",
    }
...
export function getGameSummary(sessionId) {
  return fetch(
    `${API_BASE}/game-sessions/summary?sessionId=${sessionId}`,
    {
      method: "GET",
      credentials: "include",
    }
