...
export async function startMemorySession(category) {
  const res = await fetch(`${API_BASE}/game-sessions/startMemory`, {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    credentials: "include",
    body: JSON.stringify({
...
export async function joinMemoryGame(sessionId) {
  const res = await fetch(`${API_BASE}/game-sessions/join-memory?sessionId=${sessionId}`, {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    credentials: "include",
  });
...
export async function getMemoryGameStatus(sessionId) {
  const response = await fetch(`${API_BASE}/game-sessions/memory-status?sessionId=${sessionId}`, {
    method: "GET",
    credentials: "include",
  });
  if (!response.ok) {
...
export async function getMemoryGameState(sessionId) {
  const response = await fetch(`${API_BASE}/game-sessions/memory-state?sessionId=${sessionId}`, {
    method: "GET",
    credentials: "include",
  });
  if (!response.ok) {
...
export function getGameResult(sessionId) {
  return fetch(`${API_BASE}/game-sessions/result-memory?sessionId=${sessionId}`, {
    method: "GET",
    credentials: "include",
  }).then((res) => res.json());
}
